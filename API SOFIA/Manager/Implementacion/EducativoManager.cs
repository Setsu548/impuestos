...
{
    public class EducativoManager : IEducativoManager
    {
        ...
        public EducativoManager(IConfiguration configuration, IHostingEnvironment environment)
        {
        ...
        public async Task<Resultado> RecepcionFacturaComputarizada(CompEducativaRecepcionRequest request)
        {
            ...
            request.archivo = generadorFacturas.GenerarComputarizadaEducativa(request.Factura, out xmlGenerada);
