...
namespace API_SOFIA.Controllers
{
    ...
    [ApiController]
    public class EducativaController : ControllerBase
    {    
        #region Atributos
        private readonly IConfiguration _configuration;
        private readonly IHostingEnvironment _hostingEnvironment;
        private readonly IEducativoManager _gestorFactura;
        #endregion

        public EducativaController(IConfiguration configuration,
                                     IHostingEnvironment environment)
        {
            _configuration = configuration;
            _hostingEnvironment = environment;
            _gestorFactura = new EducativoManager(_configuration, _hostingEnvironment);
        }
        ...
        [Route("recepcion")]
        [HttpPost]
        public async Task<ActionResult<Resultado>> Recepcion(CompEducativaRecepcionRequest request)
        {
